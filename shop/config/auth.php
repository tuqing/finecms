...
$config['auth'][] = array(
	'name' => '商品规格',
	'auth' => array(
		'admin/format/index' => lang('admin'),
		'admin/format/add' => lang('add'),
		'admin/format/edit' => lang('edit'),
		'admin/format/del' => lang('del'),
	)
);
...
$config['auth'][] = array(
	'name' => '商品订单',
	'auth' => array(
		'admin/order/index' => lang('admin'),
		'admin/order/del' => lang('del'),
	)
);
